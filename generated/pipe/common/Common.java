...
public final class Common {
  ...
  public  static final class Body extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pipe.common.Common.internal_static_Body_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return pipe.common.Common.internal_static_Body_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              pipe.common.Common.Body.class, pipe.common.Common.Body.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof pipe.common.Common.Body)) {
        return super.equals(obj);
      }
      pipe.common.Common.Body other = (pipe.common.Common.Body) obj;
    ...
    public static pipe.common.Common.Body parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static pipe.common.Common.Body parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static pipe.common.Common.Body parseFrom(
    ...
    public static pipe.common.Common.Body parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static pipe.common.Common.Body parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static pipe.common.Common.Body parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(pipe.common.Common.Body prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
        ...
        pipe.common.Common.BodyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return pipe.common.Common.internal_static_Body_descriptor;
      }
      ...
      // Construct using pipe.common.Common.Body.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public pipe.common.Common.Body getDefaultInstanceForType() {
        return pipe.common.Common.Body.getDefaultInstance();
      }

      public pipe.common.Common.Body build() {
        pipe.common.Common.Body result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public pipe.common.Common.Body buildPartial() {
        pipe.common.Common.Body result = new pipe.common.Common.Body(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof pipe.common.Common.Body) {
          return mergeFrom((pipe.common.Common.Body)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(pipe.common.Common.Body other) {
        if (other == pipe.common.Common.Body.getDefaultInstance()) return this;
        if (other.hasContent()) {
          bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        pipe.common.Common.Body parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (pipe.common.Common.Body) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000001;
    ...
    private static final pipe.common.Common.Body DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new pipe.common.Common.Body();
    }

    public static pipe.common.Common.Body getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "content\030\001 \002(\t\"6\n\007Failure\022\n\n\002id\030\001 \002(\005\022\016\n\006" +
      "ref_id\030\002 \001(\005\022\017\n\007message\030\003 \001(\tB\017\n\013pipe.co" +
      "mmonH\001"
    };
